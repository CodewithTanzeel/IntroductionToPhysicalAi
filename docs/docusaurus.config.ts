...
const config: Config = {
  ...
  organizationName: 'CodewithTanzeel', // Usually your GitHub org/user name.
  projectName: 'IntroductionToPhysicalAi', // Usually your repo name.
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Introduction to Physical AI. Built with Docusaurus.`,
    },
    prism: {
